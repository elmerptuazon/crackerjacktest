            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="tel_no" class="col-md-4 col-form-label text-md-right">{{ __('Telephone Number') }}</label>

                            <div class="col-md-6">
                                <input id="tel_no" type="text" class="form-control{{ $errors->has('tel_no') ? ' is-invalid' : '' }}" name="tel_no" value="{{ old('tel_no') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="address1" type="text" class="form-control{{ $errors->has('address1') ? ' is-invalid' : '' }}" name="address1" value="{{ old('address1') }}" required autofocus>
